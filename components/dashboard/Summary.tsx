...
import { useGetSummary } from "@/api/generated/dashboard-controller/dashboard-controller";
import { Wallet, TrendingUp, TrendingDown, PiggyBank, Flame } from "lucide-react";

export default function Summary() {
  const { data: response, isLoading } = useGetSummary();
  ...
  const cards = [
    ...
    },
    {
      ...
      icon: TrendingDown,
      color: "text-rose-400",
      cardBg: "bg-rose-950/20 border-rose-900/30",
    ...
    },
    {
      ...
      cardBg: "bg-indigo-950/20 border-indigo-900/30",
      iconBg: "bg-indigo-500/10 border-indigo-500/20",
    },
    {
      label: "Daily Burn Rate",
      value: summary?.dailyBurnRate,
      icon: Flame,
